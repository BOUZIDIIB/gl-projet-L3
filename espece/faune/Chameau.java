...
import structure.RefugeChameau;
...
public class Chameau extends AnimalProducteur{
	...
	public Chameau(int ligne_init, int colonne_init, Date naissance, String nom, String sexe, RefugeChameau habitat, String reference ) {
